# The name of this view in Looker is "Facebook Ads Region Report"
view: facebook_ads__region_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `facebook_ads_facebook_ads.facebook_ads__region_report` ;;
  ...
  dimension: account_business_state {
    type: string
    sql: ${TABLE}.account_business_state ;;
  }
